<form action="{{ route('buku.store') }}" method="POST">
    ...
    <div class="mb-4">
        <x-input-label for="book_title">{{ __('barang') }}</x-input-label>
    ...
    <div class="mb-4">
        <x-input-label for="author">{{ __('Nama ') }}</x-input-label>
    ...
    <div class="mb-4">
    <x-input-label for="release_year">{{ __('Tanggal') }}</x-input-label>
    <x-text-input id="release_year" class="mt-1 block w-full" type="date" name="release_year"
